	...
	SubShader
	{
		...
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Receive SSAO:false,true:true
				...
				true:SetDefine:Forward:UNLIT_DEFAULT_SSAO 1
				...
				false:RemoveDefine:Forward:UNLIT_DEFAULT_SSAO 1
			Option:Default Decal Blending:false,true:true
				true:SetDefine:Forward:UNLIT_DEFAULT_DECAL_BLENDING 1
				true:SetDefine:GBuffer:UNLIT_DEFAULT_DECAL_BLENDING 1
				false:RemoveDefine:Forward:UNLIT_DEFAULT_DECAL_BLENDING 1
				false:RemoveDefine:GBuffer:UNLIT_DEFAULT_DECAL_BLENDING 1
