Shader /*ase_name*/ "Hidden/HDRP/Decal" /*end*/
{
	Properties
    {
		...
		[HideInInspector][ToggleUI]_TransparentDynamicUpdateDecals("Boolean", Float) = 1
    ...
    SubShader
    {
		...
		/*ase_subshader_options:Name=Additional Options
			...
			Option:Transparent Dynamic Updatee:false,true:false
				true:SetShaderProperty:_TransparentDynamicUpdateDecals,[HideInInspector][ToggleUI] _TransparentDynamicUpdateDecals("Boolean", Float) = 1
				false:SetShaderProperty:_TransparentDynamicUpdateDecals,//[HideInInspector][ToggleUI] _TransparentDynamicUpdateDecals("Boolean", Float) = 1
		...
		*/
        ...
        Pass
		{
            ...
            float _AffectEmission;
			#endif
			float _TransparentDynamicUpdateDecals;
            float _DecalColorMask0;
            float _DecalColorMask1;
            float _DecalColorMask2;
            float _DecalColorMask3;
