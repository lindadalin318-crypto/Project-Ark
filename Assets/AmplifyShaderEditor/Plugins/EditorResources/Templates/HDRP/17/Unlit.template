	...
	SubShader
	{
		...
		*/
		...
		Pass
		{
			...
			#if ( UNITY_VERSION < 60010000 && defined(_ENABLE_SHADOW_MATTE) && SHADERPASS == SHADERPASS_FORWARD_UNLIT )
				#define LIGHTLOOP_DISABLE_TILE_AND_CLUSTER
				#define HAS_LIGHTLOOP
				#define SHADOW_OPTIMIZE_REGISTER_USAGE 1
		...
		Pass
		{
						...
						/*ase_frag_input*/ )
			{
				...
				/*ase_local_var:rwp*/float3 PositionRWS = packedInput.vmeshPositionRWS.xyz;
				/*ase_local_var:wvd*/float3 V = GetWorldSpaceNormalizeViewDir( packedInput.vmeshPositionRWS.xyz );
