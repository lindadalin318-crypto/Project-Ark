...
Shader "Effect/Noise_UV_Mask_URP"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 appendResult18 = (float4(( tex2DNode1 * _Color * _ColorIntensity * IN.ase_color ).rgb , 0.0));
				...
				float Alpha = ( tex2DNode1.a * IN.ase_color.a * _Color.a * ( tex2D( _Mask, lerpResult83 ).r * _MaskIntensity ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 panner56 = ( 1.0 * _Time.y * appendResult35 + uv_MainTex);
				float4 texCoord71 = IN.ase_texcoord1;
				texCoord71.xy = IN.ase_texcoord1.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult72 = (float2(texCoord71.x , texCoord71.y));
				float2 Custom1xy78 = appendResult72;
				float2 lerpResult74 = lerp( panner56 , ( Custom1xy78 + uv_MainTex ) , _Custom1xy);
				float2 temp_output_9_0_g1 = lerpResult74;
				...
				surfaceDescription.Alpha = ( tex2DNode1.a * IN.ase_color.a * _Color.a * ( tex2D( _Mask, lerpResult83 ).r * _MaskIntensity ) );
		...
		Pass
		{
				 ...
				 )
			{
				...
				float2 panner56 = ( 1.0 * _Time.y * appendResult35 + uv_MainTex);
				float4 texCoord71 = IN.ase_texcoord2;
				texCoord71.xy = IN.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 appendResult72 = (float2(texCoord71.x , texCoord71.y));
				float2 Custom1xy78 = appendResult72;
				float2 lerpResult74 = lerp( panner56 , ( Custom1xy78 + uv_MainTex ) , _Custom1xy);
				float2 temp_output_9_0_g1 = lerpResult74;
...
ASEEND*/
//CHKSM=128BB92EC4BDF098766F92DD560B2A1BF882BAC5