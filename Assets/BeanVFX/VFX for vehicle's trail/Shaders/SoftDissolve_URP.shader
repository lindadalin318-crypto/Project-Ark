	...
	SubShader
	{
		...
		Pass
		{
				 ...
				 ) : SV_Target
			{
				...
				float4 appendResult18 = (float4(( _Color * tex2DNode25 * _ColorIntensity * IN.ase_color ).rgb , 0.0));
				...
				float3 Color = appendResult18.xyz;
				float Alpha = ( tex2DNode25.a * smoothstepResult16 * IN.ase_color.a );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( tex2DNode25.a * smoothstepResult16 * IN.ase_color.a );
...
WireConnection;42;2;18;0
WireConnection;42;3;27;0
WireConnection;25;1;22;0
WireConnection;18;0;26;0
ASEEND*/
//CHKSM=0D333C00E1CFF686E8A4BB30082FF2C47562068B