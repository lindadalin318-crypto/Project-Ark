---
name: game-dev-technical
description: Technical game development implementation - performance, cross-platform, code architecture, and engine-level patternsUse when "game performance, delta time, object pooling, input abstraction, platform assumption, hardcoded keys, frame rate, draw calls, entity loop, event cleanup, requestAnimationFrame, game architecture, game code, technical gamedev, engine optimization, collision detection, physics implementation, game loop optimization" mentioned.
---
