...
| **基础设施件** | `Infrastructure` | 无 | `SpawnPoint`、`CameraConfiner` | `Navigation/SpawnPoints`、`CameraConfiner` | `Room`、`Door`、`RoomCameraConfiner` 等房间运行链 | 跟随房间运行链，不作为独立玩法状态件 | 位置语义、引用完整性、`CameraConfiner` 物理设置 |
